...
var server = new server_1.ApolloServer({
    typeDefs: typeDefs, // typeDefs -> Defining our GraphQL Types (Product, Query, Mutation)
    resolvers: resolvers // resolers -> To create logic for certain GraphQL (Query, Mutation)
